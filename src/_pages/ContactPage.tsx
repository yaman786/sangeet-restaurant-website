          ...
          >
            <div className="bg-sangeet-neutral-900 p-6 md:p-8 rounded-xl shadow-lg border border-sangeet-neutral-800">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <motion.div 
                  className="flex items-start space-x-4 p-3 rounded-lg hover:bg-sangeet-neutral-800 transition-colors cursor-pointer touch-manipulation"
                  onClick={() => window.open(`https://wa.me/${contactInfo.whatsapp?.replace(/[^0-9]/g, '') || '85293848960'}`, '_blank')}
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="flex-shrink-0 mt-1">
                    <svg className="h-5 w-5 text-sangeet-400" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div>
                    <h4 className="text-sangeet-400 font-semibold mb-1">WhatsApp</h4>
                    <p className="text-sangeet-neutral-300 text-sm md:text-base">{contactInfo.whatsapp}</p>
                    <p className="text-sangeet-neutral-400 text-xs md:text-sm">Tap to chat</p>
                  </div>
                </motion.div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    ...
                    />
                    {errors.firstName && (
                      <p className="mt-1 text-red-400 text-xs">{errors.firstName.message as string}</p>
                    )}
                  </div>
                  <div>
                    ...
                    />
                    {errors.lastName && (
                      <p className="mt-1 text-red-400 text-xs">{errors.lastName.message as string}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.email && (
                    <p className="mt-1 text-red-400 text-xs">{errors.email.message as string}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.message && (
                    <p className="mt-1 text-red-400 text-xs">{errors.message.message as string}</p>
                  )}
                </div>
