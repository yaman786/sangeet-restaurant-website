 ...
 */
export const getCartDebugInfo = (qrCode: string, tableNumber: string | null = null) => {
  const debugInfo: {
    qrCode: string;
    tableNumber: string | null;
    localStorageKeys: { key: string; value: string | null }[];
    cartData: string | null;
    customerData: string | null;
    instructionsData: string | null;
    tableCartData?: string | null;
    tableCustomerData?: string | null;
    tableInstructionsData?: string | null;
  } = {
    qrCode,
    tableNumber,
    localStorageKeys: [],
 ...
 */
export const getQRCodeFromURL = (): string | null => {
