    ...
    <>
      ...
      >
        <div className="w-7 h-7 flex items-center justify-center relative">
          ...
          >
            <div className="w-6 h-0.5 bg-red-400 rounded-full rotate-45 shadow-sm"></div>
            <div className="w-6 h-0.5 bg-red-400 rounded-full -rotate-45 absolute shadow-sm"></div>
          </motion.div>
        </div>
      </button>
          ...
          >
            ...
            <div className="px-4 py-3 border-b border-sangeet-neutral-800 bg-sangeet-neutral-800/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center justify-between bg-sangeet-neutral-800/50 backdrop-blur-sm rounded-full px-4 py-2 border border-sangeet-neutral-600/30 flex-1 mr-3">
                ...
                <button
                  ...
                  className="p-2 rounded-full bg-sangeet-neutral-800/50 hover:bg-sangeet-neutral-700/50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sangeet-400"
                  aria-label="Close menu"
                >
                  <div className="w-5 h-5 flex items-center justify-center">
                    <div className="w-4 h-0.5 bg-white rounded-full rotate-45"></div>
                    <div className="w-4 h-0.5 bg-white rounded-full -rotate-45 absolute"></div>
                  </div>
                </button>
              </div>
            </div>
